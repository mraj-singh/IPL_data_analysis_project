...
navbar = dbc.NavbarSimple(
    children=[
        dbc.NavItem(dbc.NavLink("GitHub", href="https://www.github.com/mraj-singh")),
        dbc.NavItem(dbc.NavLink("Made by Group_17", href="https://www.https://www.linkedin.com/in/mayank-raj-2175611a1/", active=True)),
    ],
    brand='IPL Analytics',
